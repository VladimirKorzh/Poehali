...
public class GoogleGeocodeApi {
    ...
    public GoogleGeocodeApi(Context c) {
        this.context = c;
    }
    ...
    public void getLocationFromString(String place){
        new getLatLngFromNameTask(context).execute(place);
    }

    public void getLocationFromLanLng(LatLng latLng){ new getStringFromLatLngTask(context).execute(latLng);}

    private class getStringFromLatLngTask extends AsyncTaskWithProgress<LatLng, Void, GeocodeApiReponse> {
        public getStringFromLatLngTask(Context activity) {
            super(activity);
        }
        ...
        protected void onPreExecute(){
            dialog.setMessage(context.getString(R.string.msg_geocode_working));
            dialog.show();
        }
    ...
    private class getLatLngFromNameTask extends AsyncTaskWithProgress<String, Void, LatLng> {
        public getLatLngFromNameTask(Context activity) {
            super(activity);
        }
